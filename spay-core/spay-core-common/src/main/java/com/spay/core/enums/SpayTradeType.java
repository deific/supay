...
public enum SpayTradeType {
     ...
     * @param name
     */
    SpayTradeType(String code, String name) {
        this.code = code;
        this.name = name;
    }
     ...
     * @return
     */
    public static SpayTradeType valueOfByCode(String code) {
        SpayTradeType[] tradeTypes = SpayTradeType.values();
        for (SpayTradeType tradeType : tradeTypes) {
